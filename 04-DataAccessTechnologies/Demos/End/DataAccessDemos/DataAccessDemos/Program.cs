...
namespace DataAccessDemos
{
  class Program
  {
    ...
    //REPLACE THE <SERVER>,<LOGIN>,<PASSWORD> & <DATABASE> below with the appropriate values for your server, login, password
    static string connectionString = "Server=tcp:<SERVER>.database.windows.net,1433;Database=<DATABASE>;User ID=<LOGIN>@<SERVER>;Password=<PASSWORD>;Trusted_Connection=False;Encrypt=True;Connection Timeout=30;";
